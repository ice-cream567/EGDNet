...
class PredNet(nn.Module):
    def __init__(self):
        ...
        self.event_c1 = nn.Conv2d(in_channels=26, out_channels=40, kernel_size=1, stride=1, padding=0, bias=False)
        ...
        self.endconv = nn.Conv2d(in_channels=40, out_channels=13, kernel_size=3, stride=1, padding=1, bias=False)
    ...
    def forward(self, batch):
        x1 = batch['blurry_frame']
        x1 = self.image_d(x1)

        event = batch['event_map']
